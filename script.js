...
const imagemInstrumento = document.querySelector(".imagem-instrumento");
...
const descricoesInstrumentos = {
    Violao: "Você é uma pessoa calma, introspectiva, que valoriza momentos de tranquilidade e reflexão. O violão é perfeito para quem gosta de transmitir serenidade através da música.",
    Bateria: "Você tem uma energia contagiante e uma personalidade extrovertida. A bateria reflete sua disposição para agitar o ambiente e motivar quem está à sua volta.",
    Saxofone: "Você é criativo, espontâneo e adora improvisar. O saxofone é ideal para expressar suas emoções de maneira única, sempre buscando o inesperado.",
    Piano: "Você é organizado, meticuloso e gosta de tudo em harmonia. O piano representa seu desejo de perfeição e equilíbrio."
};
...
function respostaSelecionada(opcaoSelecionada) {
    ...
    instrumentos[instrumentoEscolhido]++;
...
function mostraResultado(){
    ...
    textoResultado.textContent = instrumentoFinal + " - " + descricoesInstrumentos[instrumentoFinal]; // Exibe o instrumento e a descrição
    caixaAlternativas.textContent = "";
    exibeImagemInstrumento(instrumentoFinal);
}

function exibeImagemInstrumento(instrumento) {
    const imagens = {
        Violao: "violão.jpg",
        Bateria: "bateria 2.png",
        Saxofone: "saxofone.png",
        Piano: "piano.jpg"
    };

    imagemInstrumento.src = imagens[instrumento];
    imagemInstrumento.style.display = "block";
}
